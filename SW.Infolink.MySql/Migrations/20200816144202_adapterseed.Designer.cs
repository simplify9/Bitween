...
namespace SW.Infolink.MySql.Migrations
{
    ...
    [Migration("20200816144202_adapterseed")]
    partial class adapterseed
    {
            ...
            modelBuilder.Entity("SW.Infolink.Domain.Adapter", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Name = "JsonToCsvMapper",
                            Properties = "{}",
                            ServerlessId = "infolink.jsontocsvmapper",
                            Timeout = 0,
                            Type = 1
                        },
                        new
                        {
                            Id = 2,
                            Name = "JsonToXmlMapper",
                            Properties = "{}",
                            ServerlessId = "infolink.jsontoxmlmapper",
                            Timeout = 0,
                            Type = 1
                        },
                        new
                        {
                            ...
                            Name = "As2FileHandler",
                            Properties = "{}",
                            ServerlessId = "infolink.as2filehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            ...
                            Name = "FtpFileHandler",
                            Properties = "{}",
                            ServerlessId = "infolink.ftpfilehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            ...
                            Properties = "{}",
                            ServerlessId = "infolink.httpfilehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            Id = 6,
                            Name = "SftpFileHandler",
                            Properties = "{}",
                            ServerlessId = "infolink.sftpfilehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            ...
                            Name = "S3FileHandler",
                            Properties = "{}",
                            ServerlessId = "infolink.s3filehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            Id = 8,
                            Name = "AzureBlobFileHandler",
                            Properties = "{}",
                            ServerlessId = "infolink.azureblobfilehandler",
                            Timeout = 0,
                            Type = 0
                        },
                        new
                        {
                            Id = 9,
                            Name = "AzureBlobFileReceiver",
                            Properties = "{}",
                            ServerlessId = "infolink.azureBlobfilereceiver",
                            Timeout = 0,
                            Type = 2
                        },
                        new
                        {
                            Id = 10,
                            Name = "SftpFileReceiver",
                            Properties = "{}",
                            ServerlessId = "infolink.sftpfilereceiver",
                            Timeout = 0,
                            Type = 2
                        },
                        new
                        {
                            Id = 11,
                            Name = "FtpFileReceiver",
                            Properties = "{}",
                            ServerlessId = "infolink.ftpfilereceiver",
                            Timeout = 0,
                            Type = 2
                        });
                });
